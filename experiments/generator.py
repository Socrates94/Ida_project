...
"""
Generador de instancias para el análisis empírico.
Crea tableros revolviendo el estado meta con N movimientos aleatorios.
"""
#para generar las instancias: python3 -m experiments.generator --modo experimento
import os
import random
import copy
import sys
...
#Encuentra la posición del 0 el espacio vacío".
...
#Returns: Lista de rutas a los archivos generados
...
if __name__ == "__main__":
    ...
    parser.add_argument('--modo', choices=['ejemplo', 'experimento', 'tamano'], default='ejemplo', help='Modo de generación')
